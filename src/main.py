...
parser.add_argument('population', type=str)                 ## używamy argparse by łatwo przekazać wartości ze zbiorów danych do terminala
...
gdp_data, pop_data = library.clear_data(gdp_data, pop_data)                 ## wyczyszczamy dane
